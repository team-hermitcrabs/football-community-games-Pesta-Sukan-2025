...
const HUBSPOT_SERVERLESS_ENDPOINT =
	"https://www.activesgcircle.gov.sg/_hcms/api/update-data-sport-football";
const HUBDB_ROW_ID_COLUMN = 1; // Column A for storing HubDB row ID (hs_id)
const SYNC_STATUS_ID_COLUMN = 12; // Column M for storing sync status
const SYNC_MESSAGE_ID_COLUMN = 13; // Column N for storing sync message

// TARGET SHEET CONFIGURATION - Change this to switch sheets
const TARGET_SHEET_NAME = "Pesta Sukan"; // Production
/**
